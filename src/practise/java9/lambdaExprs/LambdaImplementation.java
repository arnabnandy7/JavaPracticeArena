...
public class LambdaImplementation {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			Consumer<String> myPrinter2 = msg -> System.out
		...
		final int secret = 42;
		for (int i = 0; i < 5; i++) {
			Consumer<String> myPrinter3 = msg -> System.out
					.println("Consuming " + msg + ", " + secret);
	...
	public void foo() {
		...
		for (int i = 0; i < 5; i++) {
			...
			Consumer<String> myPrinter4 = msg -> System.out
					.println("Consuming " + msg + ", " + id);
